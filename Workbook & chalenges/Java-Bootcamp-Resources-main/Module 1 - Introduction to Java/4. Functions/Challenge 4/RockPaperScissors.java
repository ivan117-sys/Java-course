...
public class RockPaperScissors {
    ...
    */
    ...
    public static String result(String yourChoice, String computerChoice) {
        String result = "";
        //  if ((yourChoice.equals("rock") && computerChoice.equals("scissors")) || (yourChoice.equals("paper") && computerChoice.equals(result)) || (yourChoice == "scissors" && computerChoice == "paper")) {
        //     result = "You win";
        //  }  else if((computerChoice == "rock" && yourChoice == "scissors") || (computerChoice == "paper" && yourChoice == "rock") || (computerChoice == "scissors" || yourChoice == "paper")) {
        //     result = "You lose";

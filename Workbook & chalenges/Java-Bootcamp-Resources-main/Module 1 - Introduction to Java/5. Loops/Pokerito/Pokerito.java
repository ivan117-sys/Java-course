...
public class Pokerito {
    public static void main(String[] args) {
        ...
        */
        ...
        System.out.print("Here is the computer card: \n " + computerCard);
        ...
        System.out.println("Your card matches: " + yourMatches + " times");

        System.out.println("Computer card matches: " + computerMatches + " times");
